from opencv_utils import strech_image
...
print('test 5')
assert strech_image(open('test_image.png', 'rb'), 0, 0) is None
print('test 6')
assert strech_image(open('test_image.png', 'rb'), 0, 50) is None
print('test 7')
assert strech_image(open('test_image.png', 'rb'), 50, 0) is None
print('test 8')
